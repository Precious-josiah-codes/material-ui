    ...
    <div>
      ...
      >
        <div style={{backgroundColor: 'grey', display: 'block', height: '40px'}}>
            <Typography style={{ color: 'black',textAlign:"center", marginTop: '8px', fontFamily: 'calibri'}}variant="subtitle1">{"Activate Voucher"}
            </Typography>
        </div>

        <DialogContent>
            <Typography id="alert-dialog-slide-description" style={{marginBottom: '1px', marginTop: '9px'}} variant="subtitle1">
            Serial Number
            </Typography>
            <TextField
            ...
            <TextField
                    ...
                    fullWidth
                />
            <Typography id="alert-dialog-slide-description" style={{marginBottom: '5px', marginTop: '10px'}} variant="subtitle1">
             Select Store
            </Typography>
